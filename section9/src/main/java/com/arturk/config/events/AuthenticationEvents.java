package com.arturk.config.events;
...
public class AuthenticationEvents {
    ...
    public void onSuccessAuthentication(AuthenticationSuccessEvent event) {
        log.info("Authentication success for user with username: {}", event.getAuthentication().getName());
    }

    @EventListener
    public void onFailureAuthentication(AbstractAuthenticationFailureEvent event) {
        log.info("Authentication failed for user with username: {}, due to: {}",
